...
def main(event, context):
    ...
    # Write to S3 archive
    df_to_s3(bids_df, coin_pair, 'bid', unix_timestamp)
    df_to_s3(asks_df, coin_pair, 'ask', unix_timestamp)
    # Engineer features
